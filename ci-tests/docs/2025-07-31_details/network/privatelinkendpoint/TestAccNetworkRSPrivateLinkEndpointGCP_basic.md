...
# Found 33 TestRuns in dev, qa from 2025-07-02 to 2025-07-31 from master branch: 1 unique tests, PASS(x 23) FAIL(x 10)
Success rate: 69.70%
...
GoTestErrorClassification(error_class='timeout',author='human',run_id='2025-07-04T01:28:53.168000+00:00-TestAccNetworkRSPrivateLinkEndpointGCP_basic',confidence=1.0,ts_when='27 days ago')
