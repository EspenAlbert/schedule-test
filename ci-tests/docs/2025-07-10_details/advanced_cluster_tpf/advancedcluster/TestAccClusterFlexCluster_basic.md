...
# Found 116 TestRuns in dev, qa from 2025-04-12 to 2025-07-10 from master branch: 1 unique tests, PASS(x 109) FAIL(x 7)
Success rate: 93.97%
...
[2025-06-05 00:35](#error-2025-06-05t0035380000) | UNEXPECTED_ERROR /api/atlas/v2/groups/6840e4e2161ca93c1f0534c7/flexClusters | dev | flaky_500 | 3.08s
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-06-26T01:58:04.802000+00:00-TestAccClusterFlexCluster_basic',confidence=1.0,ts_when='14 days ago')
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-06-30T01:50:25.782000+00:00-TestAccClusterFlexCluster_basic',confidence=1.0,ts_when='9 days ago')
CheckFailure for advanced_cluster.test at Step: 1 Checks: 10,11,25,26,40,41,52,66
```
...
GoTestErrorClassification(error_class='real_test_failure',author='human',run_id='2025-07-01T08:20:46.774000+00:00-TestAccClusterFlexCluster_basic',confidence=1.0,ts_when='8 days ago')
...
GoTestErrorClassification(error_class='flaky_check',author='human',run_id='2025-07-08T02:00:19.279000+00:00-TestAccClusterFlexCluster_basic',confidence=1.0,ts_when='2 days ago')
CheckFailure for advanced_cluster.test at Step: 1 Checks: 10,11,25,26,40,41,52,66
```
...
GoTestErrorClassification(error_class='flaky_check',author='human',run_id='2025-07-10T04:28:21.988000+00:00-TestAccClusterFlexCluster_basic',confidence=1.0,ts_when='an hour ago')
CheckFailure for advanced_cluster.test at Step: 1 Checks: 10,11,25,26,40,41,52,66
```
