...
# Found 33 TestRuns in dev, qa from 2025-10-08 to 2025-11-06 from master branch: 1 unique tests, FAIL(x 17) PASS(x 16)
Success rate: 48.48%
...
GoTestErrorClassification(error_class='dangling_resource',author='human',run_id='2025-10-20T00:42:48.442000+00:00-TestAccNetworkRSNetworkPeering_Azure',confidence=1.0,ts_when='17 days ago')
