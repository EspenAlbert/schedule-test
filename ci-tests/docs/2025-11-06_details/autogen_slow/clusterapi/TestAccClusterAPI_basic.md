...
# Found 32 TestRuns in dev, qa from 2025-10-08 to 2025-11-06 from master branch: 1 unique tests, PASS(x 29) FAIL(x 2) TIMEOUT
Success rate: 93.55%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-23T00:29:48.681000+00:00-TestAccClusterAPI_basic',confidence=1.0,ts_when='14 days ago')
