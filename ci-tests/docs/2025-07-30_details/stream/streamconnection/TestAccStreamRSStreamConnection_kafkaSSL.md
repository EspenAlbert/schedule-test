...
# Found 39 TestRuns in dev, qa from 2025-07-01 to 2025-07-30 from master branch: 1 unique tests, PASS(x 35) FAIL(x 4)
Success rate: 89.74%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-07-30T00:47:34.927000+00:00-TestAccStreamRSStreamConnection_kafkaSSL',confidence=1.0,ts_when='2 minutes ago')
Step 1 1,1,1,2
```
