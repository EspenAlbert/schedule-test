...
# Found 37 TestRuns in dev, qa from 2025-07-01 to 2025-07-30 from master branch: 1 unique tests, PASS(x 23) FAIL(x 13) TIMEOUT
Success rate: 63.89%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-07-01T00:30:13.655000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='29 days ago')
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-07-01T03:30:49.618000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='29 days ago')
...
GoTestErrorClassification(error_class='flaky_check',author='human',run_id='2025-07-01T08:33:50.514000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='29 days ago')
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-07-03T00:30:39.380000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='27 days ago')
CheckFailure for flex_cluster.test at Step: 1 Checks: 6,18,30
```
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-07-04T00:29:25.572000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='26 days ago')
...
GoTestErrorClassification(error_class='real_test_failure',author='human',run_id='2025-07-09T00:29:58.730000+00:00-TestAccFlexClusterRS_failedUpdate',confidence=1.0,ts_when='21 days ago')
