...
# Found 40 TestRuns in dev, qa from 2025-09-30 to 2025-10-30 from master branch: 1 unique tests, PASS(x 35) FAIL(x 5)
Success rate: 87.50%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-21T00:28:27.374000+00:00-TestAccClusterAdvancedClusterConfig_asymmetricShardedNewSchema',confidence=1.0,ts_when='9 days ago')
Step 1 2
```
