...
# Found 39 TestRuns in dev, qa from 2025-10-01 to 2025-10-30 from master branch: 1 unique tests, PASS(x 34) FAIL(x 5)
Success rate: 87.18%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-21T00:28:09.197000+00:00-TestAccCluster_basic_RedactClientLogData',confidence=1.0,ts_when='9 days ago')
Step 1 4
```
