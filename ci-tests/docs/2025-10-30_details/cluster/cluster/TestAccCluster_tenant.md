...
# Found 39 TestRuns in dev, qa from 2025-10-01 to 2025-10-30 from master branch: 1 unique tests, PASS(x 28) FAIL(x 10) TIMEOUT
Success rate: 73.68%
...
GoTestErrorClassification(error_class='flaky_check',author='similar',run_id='2025-10-23T00:28:17.670000+00:00-TestAccCluster_tenant',confidence=1.0,ts_when='7 days ago')
