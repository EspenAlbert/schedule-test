...
# Found 40 TestRuns in dev, qa from 2025-10-01 to 2025-10-30 from master branch: 1 unique tests, PASS(x 30) FAIL(x 10)
Success rate: 75.00%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-21T00:30:48.385000+00:00-TestAccProjectAPIKey_recreateWhenDeletedExternally',confidence=1.0,ts_when='9 days ago')
