...
# Found 41 TestRuns in dev, qa from 2025-09-30 to 2025-10-30 from master branch: 1 unique tests, FAIL(x 31) PASS(x 10)
Success rate: 24.39%
...
GoTestErrorClassification(error_class='dangling_resource',author='human',run_id='2025-10-20T00:42:48.442000+00:00-TestAccNetworkRSNetworkPeering_Azure',confidence=1.0,ts_when='10 days ago')
