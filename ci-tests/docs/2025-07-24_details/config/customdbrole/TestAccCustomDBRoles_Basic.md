...
# Found 38 TestRuns in dev, qa from 2025-06-25 to 2025-07-24 from master branch: 1 unique tests, PASS(x 31) FAIL(x 7)
Success rate: 81.58%
...
GoTestErrorClassification(error_class='real_test_failure',author='human',run_id='2025-07-10T13:08:21.920000+00:00-TestAccCustomDBRoles_Basic',confidence=1.0,ts_when='13 days ago')
