...
# Found 37 TestRuns in dev, qa from 2025-06-25 to 2025-07-24 from master branch: 1 unique tests, PASS(x 28) FAIL(x 9)
Success rate: 75.68%
...
GoTestErrorClassification(error_class='flaky_check',author='similar',run_id='2025-07-01T00:30:00.183000+00:00-TestAccFlexClusterRS_basic',confidence=1.0,ts_when='23 days ago')
...
GoTestErrorClassification(error_class='flaky_check',author='human',run_id='2025-07-01T08:33:36.548000+00:00-TestAccFlexClusterRS_basic',confidence=1.0,ts_when='23 days ago')
API Error ATLAS_GENERAL_ERROR /api/atlas/v2/groups/{groupId}/flexClusters/{name}
```
...
GoTestErrorClassification(error_class='flaky_check',author='similar',run_id='2025-07-04T00:29:00.962000+00:00-TestAccFlexClusterRS_basic',confidence=1.0,ts_when='20 days ago')
API Error ATLAS_GENERAL_ERROR /api/atlas/v2/groups/{groupId}/flexClusters/{name}
```
...
GoTestErrorClassification(error_class='flaky_check',author='similar',run_id='2025-07-09T00:29:44.920000+00:00-TestAccFlexClusterRS_basic',confidence=1.0,ts_when='15 days ago')
API Error ATLAS_GENERAL_ERROR /api/atlas/v2/groups/{groupId}/flexClusters/{name}
```
