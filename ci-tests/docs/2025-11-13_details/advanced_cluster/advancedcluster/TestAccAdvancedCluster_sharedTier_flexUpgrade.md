...
# Found 33 TestRuns in dev, qa from 2025-10-15 to 2025-11-13 from master branch: 1 unique tests, PASS(x 20) FAIL(x 9) SKIP(x 4)
Success rate: 68.97%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-22T00:29:11.736000+00:00-TestAccAdvancedCluster_sharedTier_flexUpgrade',confidence=1.0,ts_when='22 days ago')
