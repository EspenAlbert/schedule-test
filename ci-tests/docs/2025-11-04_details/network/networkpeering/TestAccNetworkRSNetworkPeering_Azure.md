...
# Found 32 TestRuns in dev, qa from 2025-10-06 to 2025-11-04 from master branch: 1 unique tests, FAIL(x 19) PASS(x 13)
Success rate: 40.62%
...
GoTestErrorClassification(error_class='dangling_resource',author='human',run_id='2025-10-20T00:42:48.442000+00:00-TestAccNetworkRSNetworkPeering_Azure',confidence=1.0,ts_when='14 days ago')
