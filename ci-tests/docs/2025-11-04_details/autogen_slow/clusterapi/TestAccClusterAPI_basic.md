...
# Found 30 TestRuns in dev, qa from 2025-10-07 to 2025-11-04 from master branch: 1 unique tests, PASS(x 26) FAIL(x 3) TIMEOUT
Success rate: 89.66%
...
GoTestErrorClassification(error_class='unknown',author='human',run_id='2025-10-23T00:29:48.681000+00:00-TestAccClusterAPI_basic',confidence=1.0,ts_when='12 days ago')
