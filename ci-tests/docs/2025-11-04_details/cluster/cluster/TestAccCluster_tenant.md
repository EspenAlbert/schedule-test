...
# Found 31 TestRuns in dev, qa from 2025-10-06 to 2025-11-04 from master branch: 1 unique tests, PASS(x 26) FAIL(x 4) TIMEOUT
Success rate: 86.67%
...
GoTestErrorClassification(error_class='flaky_check',author='similar',run_id='2025-10-23T00:28:17.670000+00:00-TestAccCluster_tenant',confidence=1.0,ts_when='12 days ago')
